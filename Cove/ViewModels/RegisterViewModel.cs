...
using Cove.Web.CustomValidations;

namespace Cove.Web.ViewModels
{
    public class RegisterViewModel
    {
        ...
        [StringLength(1000, ErrorMessage = "Profile length should have  min 2 and max 1000 characters. ", MinimumLength = 2)]
        public string Profile { get; set; }

        [Display(Name = "Specialisation")]

        [SpecialisationValidator(ErrorMessage ="Please select Specialisation")]
